        ...
        prescriptions.map((prescription) => (
          ...
          >
            ...
            <Text fontSize="sm" mb={2}>
              <strong>Technical Name:</strong> {prescription.technicalName}
            </Text>
            <Text fontSize="sm" mb={2}>
            ...
            <Text fontSize="sm" mb={2}>
              ...
              {`${prescription.providerInfo.firstName} ${prescription.providerInfo.lastName}, ${prescription.providerInfo.specialty}`}
            </Text>
            <HStack mt={4}>
              <Icon
